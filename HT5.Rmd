...
```{r}
  ...
  #datos[,c(1:2,4:5,18:21,27,35,37:39,44:53,55,57,60,62,63,67:72,76:78,81)] <- lapply(datos[,c(1:2,4:5,18:21,27,35,37:39,44:53,55,57,60,62,63,67:72,76:78,81)], as.numeric)
...
```{r}
ct<-trainControl(method = "cv",train[,2:80],number=10, verboseIter=T)
